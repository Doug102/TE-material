namespace Exercises
{
    public partial class Exercises
    {
        ...
        {
            if (!isBirthday && mealAmount <= 10)
            {
                return "standard";
            }
            else if (!isBirthday && (mealAmount <= 15 && mealAmount > 10))
            {
                return "special";
            }
            else if (!isBirthday && mealAmount > 15)
            {
                return "ginormous";
            }
            else if (isBirthday && mealAmount <= 5)
            {
                return "standard";
            }
            else if (isBirthday && (mealAmount <= 10 && mealAmount > 5))
            {
                return "special";
            }
