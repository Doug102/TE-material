...
namespace PetInfoServer
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddTransient<ICustomerDAO, CustomerDAO>(m => new CustomerDAO(connectionString));
            services.AddTransient<IProcedureDAO, ProcedureDAO>(m => new ProcedureDAO(connectionString));
