        ...
        private void ShowMainMenu()
        {
            ...
            while (menuSelection != 0)
            {
                ...
                else
                {
                    ...
                    {
                        case 1:
                            consoleService.CaseOne();
                            break;
                        case 2:
                            consoleService.CaseTwo();
                            break;
                        case 3:
                            consoleService.CaseThree();
                            break;
                        case 4:
                            consoleService.CaseFour();
                            break;
                        case 5:
                            consoleService.CaseFive();
                            break;
                        case 6:
                            Console.WriteLine();
        ...
        private void HandleUserLogin()
        {
            while (!UserService.IsLoggedIn) //will keep looping until user is logged in
            {
                ...
                if (user != null)
                {
                    ...
                    consoleService.UserIdAndName(api_User);
