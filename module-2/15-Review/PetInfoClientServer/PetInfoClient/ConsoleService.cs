    ...
    public class ConsoleService
    {
        ...
        private void ListPets()
        {
            try
            {
                ...
                {
                    Console.WriteLine(pet); // calls the overridden ToString method for Pet
                }
                Console.WriteLine();
            }
            catch (Exception ex)
        ...
        private void AddAPet()
        {
            try
            {
                ...
                ListOwners();
                Console.WriteLine("Enter Owner ID (1001):");
        ...
        private void ListOwners()
        {
            ...
            Console.WriteLine("John is 1000");
            Console.WriteLine("Lisa is 1001");
            Console.WriteLine();
