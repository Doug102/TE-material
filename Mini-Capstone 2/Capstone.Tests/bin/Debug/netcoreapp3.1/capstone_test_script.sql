...
ALTER TABLE category_venue NOCHECK CONSTRAINT all
ALTER TABLE city NOCHECK CONSTRAINT all
ALTER TABLE reservation NOCHECK CONSTRAINT all
ALTER TABLE space NOCHECK CONSTRAINT all
ALTER TABLE state NOCHECK CONSTRAINT all
ALTER TABLE venue NOCHECK CONSTRAINT all
...
ALTER TABLE category_venue WITH CHECK CHECK CONSTRAINT all
ALTER TABLE city WITH CHECK CHECK CONSTRAINT all
ALTER TABLE reservation WITH CHECK CHECK CONSTRAINT all
ALTER TABLE space WITH CHECK CHECK CONSTRAINT all
ALTER TABLE state WITH CHECK CHECK CONSTRAINT all
ALTER TABLE venue WITH CHECK CHECK CONSTRAINT all
