...
document.addEventListener('DOMContentLoaded', () => {
  ...
  groceryItems.forEach((grocery) => {
    grocery.addEventListener('click', (eventObject) => {
      console.log('reached event for click');
  ...
  groceryItems.forEach((grocery) => {
    grocery.addEventListener('dblclick', (eventObject) => {
      console.log('reached event for dblclick');
      if (grocery.classList.contains('completed')) {
  ...
  toggleAll.addEventListener('click', (eventObject) => {
