...
function displayReviews() {
  if ('content' in document.createElement('template')) {//checks browser to see if templates are supported. most modern browsers do so this is kinda optional
    ...
    console.error('Your browser does not support templates');//if templates are not supported this is displayed.
  }
}
