const title = 'Cigar Parties for Dummies';
...
function setPageDescription() {
  const el = document.querySelector('p.description');
...
function displayReviews() {
  ...
  reviews.forEach(item => {
    ...
    testElement.classList.add('review');
    addReviewer(testElement, item.reviewer);
    addReview(testElement, item.review);
...
function addReview(parent, review) {
  const reviewArea = document.createElement('p');
  reviewArea.innerText = review;
  parent.appendChild(reviewArea);
 }
