<template>
  <div class="main">
    ...
    <input type="text" v-on:change="inputChanged" />
    <button v-if="!showForm" v-on:click="toggleShowForm">Add Review</button>
    <form v-else v-on:submit.prevent="addNewReview">
      ...
      <input type="button" value="Cancel" v-on:click="toggleShowForm" />
    </form>
