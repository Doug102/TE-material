<template>
  <div class="main">
    ...
    <div class="well-display">
      <div class="well">
        <span class="amount">{{averageRating}}<!-- data binding goes here --></span>
        Average Rating
      </div>
      ...
      <div class="well">
        <span class="amount">{{numberOfTwoStarReviews}}<!-- data binding goes here --></span>
        2 Star Review
      </div>
